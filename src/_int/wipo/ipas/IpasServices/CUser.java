...
public class CUser  implements java.io.Serializable {
    ...
    /**
     * Gets the userId value for this CUser.
     * 
     * @return userId
     */
    ...
    /**
     * Sets the userId value for this CUser.
     * 
     * @param userId
     */
    ...
    /**
     * Gets the userName value for this CUser.
     * 
     * @return userName
     */
    ...
    /**
     * Sets the userName value for this CUser.
     * 
     * @param userName
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ipas.wipo.int/IpasServices", "cUser"));
